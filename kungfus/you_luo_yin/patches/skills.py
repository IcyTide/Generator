...
SKILLS = {
    ...
    42084: {1: {}},
    42265: dict(dest_rollback_attributes=[("coming_damage_cof", 205 * Variable("belong_42128"))]),
    41486: dict(comment="递增{level-1}跳"),
    41994: {1: {}},
    42098: {1: dict(dest_rollback_attributes=[("coming_damage_cof", 1024 * Variable("belong_42115"))])},
