                ...
                "skills": {
                    600: {
                        1: {
                            "name": "叠刃",
                            "comment": "原始",
                            "damage": "(10 + physical_attack_power * int(140 * (1 + 0.3999999999999999 * recipe_4583_1)) * 0.0015625) * (1 + physical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (physical_shield_base * (1 + physical_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + physical_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + physical_damage_cof / 1024)",
                ...
                "skills": {
                    285: {
                        24: {
                            "name": "钟林毓秀",
                            "comment": "",
                            "damage": "(38 + neutral_attack_power * int(633.2842332689337 * (1 + 0.1499999999999999 * recipe_817_1) * (1 + 1.2000000000000002 * recipe_2942_1) * (1 + 0.050000000000000044 * recipe_1302_1)) * 0.0013020833333333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (neutral_shield_base * (1 + neutral_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + neutral_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + neutral_damage_cof / 1024)",
                            "critical_damage": "damage * neutral_critical_power",
                            "critical_strike": "neutral_critical_strike"
                        }
                    },
                    ...
                    39907: {
                        1: {
                            "name": "",
                            "comment": "乱洒青荷",
                            "damage": "(38 + neutral_attack_power * int(759.9410799227204 * (1 + 0.1499999999999999 * recipe_817_1) * (1 + 1.2000000000000002 * recipe_2942_1) * (1 + 0.050000000000000044 * recipe_1302_1)) * 0.0013020833333333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (neutral_shield_base * (1 + neutral_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + neutral_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + neutral_damage_cof / 1024)",
                            "critical_damage": "damage * neutral_critical_power",
                            "critical_strike": "neutral_critical_strike"
                        },
                        2: {
                    ...
                    40086: {
                        1: {
                            "name": "",
                            "comment": "飞白2段",
                            "damage": "(38 + neutral_attack_power * int(1393.2253131916543 * (1 + 0.1499999999999999 * recipe_817_1) * (1 + 1.2000000000000002 * recipe_2942_1) * (1 + 0.050000000000000044 * recipe_1302_1)) * 0.0013020833333333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (neutral_shield_base * (1 + neutral_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + neutral_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + neutral_damage_cof / 1024)",
                            "critical_damage": "damage * neutral_critical_power",
                            "critical_strike": "neutral_critical_strike"
                        }
                    },
                ...
                "skills": {
                    3126: {
                        1: {
                            "name": "",
                            "comment": "原始",
                            "damage": "(90 + poison_attack_power * 0.6770833333333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        },
                        2: {
                            "name": "",
                            "comment": "千秋万劫",
                            "damage": "(90 + poison_attack_power * 1.3541666666666665) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        },
                        3: {
                            "name": "",
                            "comment": "尽刑彻毒",
                            "damage": "(90 + poison_attack_power * 2.03125) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        },
                        4: {
                            "name": "",
                            "comment": "千秋万劫+尽刑彻毒",
                            "damage": "(90 + poison_attack_power * 4.063802083333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        }
                    }
                ...
                "skills": {
                    3126: {
                        1: {
                            "name": "",
                            "comment": "原始",
                            "damage": "(90 + poison_attack_power * 0.22569444444444442) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        },
                        2: {
                            "name": "",
                            "comment": "千秋万劫",
                            "damage": "(90 + poison_attack_power * 0.45138888888888884) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        },
                        3: {
                        ...
                        4: {
                            "name": "",
                            "comment": "千秋万劫+尽刑彻毒",
                            "damage": "(90 + poison_attack_power * 1.3546006944444444) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (poison_shield_base * (1 + poison_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + poison_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + poison_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        }
                    }
                ...
                "skills": {
                    6853: {
                        20: {
                            "name": "",
                            "comment": "",
                            "damage": "(32 + physical_attack_power * 0.6531250000000001) * (1 + physical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (physical_shield_base * (1 + physical_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + physical_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + physical_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        }
                    }
                ...
                "skills": {
                    6867: {
                        20: {
                            "name": "",
                            "comment": "",
                            "damage": "(33 + physical_attack_power * 0.5578125) * (1 + physical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (physical_shield_base * (1 + physical_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + physical_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + physical_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        }
                    }
                ...
                "skills": {
                    42918: {
                        20: {
                            "name": "",
                            "comment": "",
                            "damage": "(33 + physical_attack_power * 0.5572916666666666) * (1 + physical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (physical_shield_base * (1 + physical_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + physical_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + physical_damage_cof / 1024)",
                            "critical_damage": "damage * physical_critical_power",
                            "critical_strike": "physical_critical_strike"
                        }
                    }
                ...
                "skills": {
                    43082: {
                        1: {
                            "name": "",
                            "comment": "",
                            "damage": "(58 + lunar_attack_power * 0.2864583333333333) * (1 + magical_damage_addition / 1024) * (1 + skill_damage_final_cof / 1024) * shield_constant / (lunar_shield_base * (1 + lunar_shield_gain / 1024) * (1 - all_shield_ignore / 1024) + shield_constant) * (1 + lunar_overcome) * (1 - (level - 130) * 0.05) * (1 + strain) * (1 + pve_addition_base / 1024) * (1 + lunar_damage_cof / 1024)",
                            "critical_damage": "damage * lunar_critical_power",
                            "critical_strike": "lunar_critical_strike"
                        }
                    }
